...
func _ready() -> void:
	...
	if mesh.has_meta("pizza"):
		...
		if pizza_type == GlobalVar.PIZZA_TYPE.PEPPERONI:
			pizza_slot.add_child(preload("res://assets/kaykit/restaurant/food_pizza_pepperoni_plated.gltf").instantiate())
		if pizza_type == GlobalVar.PIZZA_TYPE.MUSHROOM:
			pizza_slot.add_child(preload("res://assets/kaykit/restaurant/food_pizza_mushroom_plated.gltf").instantiate())
		if pizza_type == GlobalVar.PIZZA_TYPE.CHEESE:
			pizza_slot.add_child(preload("res://assets/kaykit/restaurant/food_pizza_cheese_plated.gltf").instantiate())
